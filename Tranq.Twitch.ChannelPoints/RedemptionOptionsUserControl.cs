...
{
    public partial class RedemptionOptionsUserControl : UserControl
    {
        private IChannelPointsService channelPointsService;

        public RedemptionOptionsUserControl()
        {
            InitializeComponent();
            comboBox1.DataSource = Enum.GetValues(typeof(OptionAction));
        }

        public void RedemptionOptionsWindow_Load(IChannelPointsService channelPointsService)
        {
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            channelPointsService.DeleteRewardOption(ActiveSelection);
